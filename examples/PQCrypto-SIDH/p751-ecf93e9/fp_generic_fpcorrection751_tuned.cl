(* @laptop: cv -v -isafety fp_generic_fpcorrection751_tuned.cl
Parsing Cryptoline file:		[OK]		0.003808 seconds
Checking well-formedness:		[OK]		0.001437 seconds
Transforming to SSA form:		[OK]		0.000584 seconds
Normalizing specification:		[OK]		0.000507 seconds
Rewriting assignments:			[OK]		0.000435 seconds
Verifying program safety:		[OK]		0.628857 seconds
Verifying range specification:		[OK]		31.085287 seconds
Rewriting value-preserved casting:	[OK]		0.000091 seconds
Verifying algebraic specification:	[OK]		0.000233 seconds
Verification result:			[OK]		31.722041 seconds
*)
...
mov a_80 a10;
mov a_88 a11;
mov p751_0 0xFFFFFFFFFFFFFFFF@uint64;
mov p751_8 0xFFFFFFFFFFFFFFFF@uint64;
mov p751_16 0xFFFFFFFFFFFFFFFF@uint64;
mov p751_24 0xFFFFFFFFFFFFFFFF@uint64;
mov p751_32 0xFFFFFFFFFFFFFFFF@uint64;
mov p751_40 0xEEAFFFFFFFFFFFFF@uint64;
mov p751_48 0xE3EC968549F878A8@uint64;
mov p751_56 0xDA959B1A13F7CC76@uint64;
mov p751_64 0x084E9867D6EBE876@uint64;
mov p751_72 0x8562B5045CB25748@uint64;
mov p751_80 0x0E12909F97BADC66@uint64;
mov p751_88 0x00006FE5D541F71C@uint64;
