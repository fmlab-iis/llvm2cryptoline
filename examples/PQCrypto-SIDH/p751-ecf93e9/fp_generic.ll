...
entry:
  ...
  call void @llvm.memset.p0i8.i64(i8* align 8 %mc372, i8 0, i64 96, i1 false)
...
for.body6.lr.ph:                                  ; preds = %for.cond4.preheader
  %0 = add nuw i64 %indvars.iv365, 4294967292
...
if.then:                                          ; preds = %for.body6
  ...
  %arrayidx12 = getelementptr inbounds [12 x i64], [12 x i64]* @p751p1, i64 0, i64 %idxprom11
...
for.body68.lr.ph:                                 ; preds = %for.end30, %for.end100
  ...
  %8 = add nsw i64 %indvars.iv356, -12
  %sub69 = sub i32 12, %spec.select
...
if.then72:                                        ; preds = %for.body68
  ...
  %arrayidx77 = getelementptr inbounds [12 x i64], [12 x i64]* @p751p1, i64 0, i64 %11
...
for.inc98:                                        ; preds = %for.body68, %if.then72
  ...
  %exitcond = icmp eq i64 %indvars.iv.next354, 12
...
for.end100:                                       ; preds = %for.inc98
  ...
  %exitcond360 = icmp eq i64 %indvars.iv.next357, 23
...
for.end124:                                       ; preds = %for.end100
  ...
  %arrayidx132 = getelementptr inbounds i64, i64* %mc, i64 11
