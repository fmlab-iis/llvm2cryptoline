(* @laptop: cv -v -jobs 8 -isafety -slicing -no_carry_constraint fp_generic_unroll_rdc_mont_tuned.cl
Parsing Cryptoline file:		[OK]		0.028533 seconds
Checking well-formedness:		[OK]		0.009019 seconds
Transforming to SSA form:		[OK]		0.005213 seconds
Normalizing specification:		[OK]		0.002678 seconds
Rewriting assignments:			[OK]		0.001236 seconds
Verifying program safety:		[OK]		19.552666 seconds
Verifying range assertions:		[OK]		192.919485 seconds
Verifying range specification:		[OK]		687.755792 seconds
Rewriting value-preserved casting:	[OK]		0.000189 seconds
Verifying algebraic assertions:		[OK]		0.005127 seconds
Verifying algebraic specification:	[OK]		0.598588 seconds
Verification result:			[OK]		900.882969 seconds
*)

proc main (uint64 ma00, uint64 ma01, uint64 ma02, uint64 ma03, uint64 ma04, uint64 ma05, uint64 ma06, uint64 ma07, uint64 ma08, uint64 ma09, uint64 ma10, uint64 ma11, uint64 ma12, uint64 ma13, uint64 ma14, uint64 ma15) =
{
  true
  &&
  (* p503 = 2^250*3^159-1 *)
  (* R = 2^512 *)
  (* ma < 2^512*p503 *)
  limbs 64 [ma00, ma01, ma02, ma03, ma04, ma05, ma06, ma07, ma08, ma09, ma10, ma11, ma12, ma13, ma14, ma15]
    <u const 1024 (2**512) * const 1024 (2**250 * 3**159 - 1)
}
...
mov p503p1_0 0x0000000000000000@uint64;
mov p503p1_8 0x0000000000000000@uint64;
mov p503p1_16 0x0000000000000000@uint64;
mov p503p1_24 0xAC00000000000000@uint64;
mov p503p1_32 0x13085BDA2211E7A0@uint64;
mov p503p1_40 0x1B9BF6C87B7E7DAF@uint64;
mov p503p1_48 0x6045C6BDDA77A4D0@uint64;
mov p503p1_56 0x004066F541811E1E@uint64;
...
(* generated by python *)
assert true && limbs 64 [v_add35_2, v_shr_i301_2] = limbs 64 [v4, 0@64] + limbs 64 [v_add41_1, 0@64];
assume limbs 64 [v_add35_2, v_shr_i301_2] = limbs 64 [v4, 0] + limbs 64 [v_add41_1, 0] && true;
...
(* generated by python *)
assert true && limbs 64 [v_add16_3, v_shr_i319_3] = limbs 64 [v_xor68_i_3, 0@64] + limbs 64 [v_shr_i301_2, 0@64] + limbs 64 [v_shr_i295_1, 0@64];
assume limbs 64 [v_add16_3, v_shr_i319_3] = limbs 64 [v_xor68_i_3, 0] + limbs 64 [v_shr_i301_2, 0] + limbs 64 [v_shr_i295_1, 0] && true;
...
(* generated by python *)
assert true && limbs 64 [v_add20_3, v_or25327_3] = limbs 64 [v_shr_i319_3, 0@64] + limbs 64 [v_xor2569_i_3, 0@64];
assume limbs 64 [v_add20_3, v_or25327_3] = limbs 64 [v_shr_i319_3, 0] + limbs 64 [v_xor2569_i_3, 0] && true;
...
(* generated by python *)
assert true && limbs 64 [v_add35_3, v_shr_i301_3] = limbs 64 [v9, 0@64] + limbs 64 [v_add16_3, 0@64];
assume limbs 64 [v_add35_3, v_shr_i301_3] = limbs 64 [v9, 0] + limbs 64 [v_add16_3, 0] && true;
...
(* generated by python *)
assert true && limbs 64 [v_add41_3, v_shr_i295_3] = limbs 64 [v_shr_i301_3, 0@64] + limbs 64 [v_add20_3, 0@64];
assume limbs 64 [v_add41_3, v_shr_i295_3] = limbs 64 [v_shr_i301_3, 0] + limbs 64 [v_add20_3, 0] && true;
...
(* generated by python *)
assert true && limbs 64 [v_add21_4, v_or25327_4] = limbs 64 [v_shr_i319_4, 0@64] + limbs 64 [v_xor2569_i_4, 0@64] + limbs 64 [v_add48_3, 0@64];
assume limbs 64 [v_add21_4, v_or25327_4] = limbs 64 [v_shr_i319_4, 0] + limbs 64 [v_xor2569_i_4, 0] + limbs 64 [v_add48_3, 0] && true;
...
(* generated by python *)
assert true && limbs 64 [v_add16_4_1, v_shr_i319_4_1] = limbs 64 [v_xor68_i_4_1, 0@64] + limbs 64 [v_add16_4, 0@64];
assume limbs 64 [v_add16_4_1, v_shr_i319_4_1] = limbs 64 [v_xor68_i_4_1, 0] + limbs 64 [v_add16_4, 0] && true;
...
(* generated by python *)
assert true && limbs 64 [v_add21_4_1, v_or25327_4_1] = limbs 64 [v_shr_i319_4_1, 0@64] + limbs 64 [v_xor2569_i_4_1, 0@64] + limbs 64 [v_add21_4, 0@64];
assume limbs 64 [v_add21_4_1, v_or25327_4_1] = limbs 64 [v_shr_i319_4_1, 0] + limbs 64 [v_xor2569_i_4_1, 0] + limbs 64 [v_add21_4, 0] && true;
...
(* generated by python *)
assert true && limbs 64 [v_add35_4, v_shr_i301_4] = limbs 64 [v17, 0@64] + limbs 64 [v_add16_4_1, 0@64];
assume limbs 64 [v_add35_4, v_shr_i301_4] = limbs 64 [v17, 0] + limbs 64 [v_add16_4_1, 0] && true;
...
(* generated by python *)
assert true && limbs 64 [v_add41_4, v_shr_i295_4] = limbs 64 [v_shr_i301_4, 0@64] + limbs 64 [v_add21_4_1, 0@64];
assume limbs 64 [v_add41_4, v_shr_i295_4] = limbs 64 [v_shr_i301_4, 0] + limbs 64 [v_add21_4_1, 0] && true;
...
(* generated by python *)
assert true && limbs 64 [v_add16_5_2, v_shr_i319_5_2] = limbs 64 [v_xor68_i_5_2, 0@64] + limbs 64 [v_add16_5_1, 0@64];
assume limbs 64 [v_add16_5_2, v_shr_i319_5_2] = limbs 64 [v_xor68_i_5_2, 0] + limbs 64 [v_add16_5_1, 0] && true;
...
(* generated by python *)
assert true && limbs 64 [v_add21_5_2, v_or25327_5_2] = limbs 64 [v_shr_i319_5_2, 0@64] + limbs 64 [v_xor2569_i_5_2, 0@64] + limbs 64 [v_add21_5_1, 0@64];
assume limbs 64 [v_add21_5_2, v_or25327_5_2] = limbs 64 [v_shr_i319_5_2, 0] + limbs 64 [v_xor2569_i_5_2, 0] + limbs 64 [v_add21_5_1, 0] && true;
...
(* generated by python *)
assert true && limbs 64 [v_add35_5, v_shr_i301_5] = limbs 64 [v28, 0@64] + limbs 64 [v_add16_5_2, 0@64];
assume limbs 64 [v_add35_5, v_shr_i301_5] = limbs 64 [v28, 0] + limbs 64 [v_add16_5_2, 0] && true;
...
(* generated by python *)
assert true && limbs 64 [v_add41_5, v_shr_i295_5] = limbs 64 [v_shr_i301_5, 0@64] + limbs 64 [v_add21_5_2, 0@64];
assume limbs 64 [v_add41_5, v_shr_i295_5] = limbs 64 [v_shr_i301_5, 0] + limbs 64 [v_add21_5_2, 0] && true;
...
(* generated by python *)
assert true && limbs 64 [v_add16_6_3, v_shr_i319_6_3] = limbs 64 [v_xor68_i_6_3, 0@64] + limbs 64 [v_add16_6_2, 0@64];
assume limbs 64 [v_add16_6_3, v_shr_i319_6_3] = limbs 64 [v_xor68_i_6_3, 0] + limbs 64 [v_add16_6_2, 0] && true;
...
(* generated by python *)
assert true && limbs 64 [v_add21_6_3, v_or25327_6_3] = limbs 64 [v_shr_i319_6_3, 0@64] + limbs 64 [v_xor2569_i_6_3, 0@64] + limbs 64 [v_add21_6_2, 0@64];
assume limbs 64 [v_add21_6_3, v_or25327_6_3] = limbs 64 [v_shr_i319_6_3, 0] + limbs 64 [v_xor2569_i_6_3, 0] + limbs 64 [v_add21_6_2, 0] && true;
...
(* generated by python *)
assert true && limbs 64 [v_add35_6, v_shr_i301_6] = limbs 64 [v42, 0@64] + limbs 64 [v_add16_6_3, 0@64];
assume limbs 64 [v_add35_6, v_shr_i301_6] = limbs 64 [v42, 0] + limbs 64 [v_add16_6_3, 0] && true;
...
(* generated by python *)
assert true && limbs 64 [v_add41_6, v_shr_i295_6] = limbs 64 [v_shr_i301_6, 0@64] + limbs 64 [v_add21_6_3, 0@64];
assume limbs 64 [v_add41_6, v_shr_i295_6] = limbs 64 [v_shr_i301_6, 0] + limbs 64 [v_add21_6_3, 0] && true;
...
(* generated by python *)
assert true && limbs 64 [v_add16_7_4, v_shr_i319_7_4] = limbs 64 [v_xor68_i_7_4, 0@64] + limbs 64 [v_add16_7_3, 0@64];
assume limbs 64 [v_add16_7_4, v_shr_i319_7_4] = limbs 64 [v_xor68_i_7_4, 0] + limbs 64 [v_add16_7_3, 0] && true;
...
(* generated by python *)
assert true && limbs 64 [v_add21_7_4, v_or25327_7_4] = limbs 64 [v_shr_i319_7_4, 0@64] + limbs 64 [v_xor2569_i_7_4, 0@64] + limbs 64 [v_add21_7_3, 0@64];
assume limbs 64 [v_add21_7_4, v_or25327_7_4] = limbs 64 [v_shr_i319_7_4, 0] + limbs 64 [v_xor2569_i_7_4, 0] + limbs 64 [v_add21_7_3, 0] && true;
...
(* generated by python *)
assert true && limbs 64 [v_add35_7, v_shr_i301_7] = limbs 64 [v59, 0@64] + limbs 64 [v_add16_7_4, 0@64];
assume limbs 64 [v_add35_7, v_shr_i301_7] = limbs 64 [v59, 0] + limbs 64 [v_add16_7_4, 0] && true;
...
(* generated by python *)
assert true && limbs 64 [v_add41_7, v_shr_i295_7] = limbs 64 [v_shr_i301_7, 0@64] + limbs 64 [v_add21_7_4, 0@64];
assume limbs 64 [v_add41_7, v_shr_i295_7] = limbs 64 [v_shr_i301_7, 0] + limbs 64 [v_add21_7_4, 0] && true;
...
(* generated by python *)
assert true && limbs 64 [v_add82, v_shr_i260] = limbs 64 [v_xor68_i278, 0@64] + limbs 64 [v_add41_7, 0@64];
assume limbs 64 [v_add82, v_shr_i260] = limbs 64 [v_xor68_i278, 0] + limbs 64 [v_add41_7, 0] && true;
...
(* generated by python *)
assert true && limbs 64 [v_add90, v_or94325] = limbs 64 [v_shr_i260, 0@64] + limbs 64 [v_xor2569_i290, 0@64] + limbs 64 [v_add48_7, 0@64];
assume limbs 64 [v_add90, v_or94325] = limbs 64 [v_shr_i260, 0] + limbs 64 [v_xor2569_i290, 0] + limbs 64 [v_add48_7, 0] && true;
...
(* generated by python *)
assert true && limbs 64 [v_add105, v_shr_i242] = limbs 64 [v76, 0@64] + limbs 64 [v_add82_4551, 0@64];
assume limbs 64 [v_add105, v_shr_i242] = limbs 64 [v76, 0] + limbs 64 [v_add82_4551, 0] && true;
...
(* generated by python *)
assert true && limbs 64 [v_add111, v_shr_i237] = limbs 64 [v_shr_i242, 0@64] + limbs 64 [v_add90_4558, 0@64];
assume limbs 64 [v_add111, v_shr_i237] = limbs 64 [v_shr_i242, 0] + limbs 64 [v_add90_4558, 0] && true;
...
(* generated by python *)
assert true && limbs 64 [v_add105_1, v_shr_i242_1] = limbs 64 [v93, 0@64] + limbs 64 [v_add82_1_4, 0@64];
assume limbs 64 [v_add105_1, v_shr_i242_1] = limbs 64 [v93, 0] + limbs 64 [v_add82_1_4, 0] && true;
...
(* generated by python *)
assert true && limbs 64 [v_add111_1, v_shr_i237_1] = limbs 64 [v_shr_i242_1, 0@64] + limbs 64 [v_add90_1_4, 0@64];
assume limbs 64 [v_add111_1, v_shr_i237_1] = limbs 64 [v_shr_i242_1, 0] + limbs 64 [v_add90_1_4, 0] && true;
...
(* generated by python *)
assert true && limbs 64 [v_add105_2, v_shr_i242_2] = limbs 64 [v110, 0@64] + limbs 64 [v_add82_2_4, 0@64];
assume limbs 64 [v_add105_2, v_shr_i242_2] = limbs 64 [v110, 0] + limbs 64 [v_add82_2_4, 0] && true;
...
(* generated by python *)
assert true && limbs 64 [v_add111_2, v_shr_i237_2] = limbs 64 [v_shr_i242_2, 0@64] + limbs 64 [v_add90_2_4, 0@64];
assume limbs 64 [v_add111_2, v_shr_i237_2] = limbs 64 [v_shr_i242_2, 0] + limbs 64 [v_add90_2_4, 0] && true;
...
(* generated by python *)
assert true && limbs 64 [v_add105_3, v_shr_i242_3] = limbs 64 [v124, 0@64] + limbs 64 [v_add82_3_3, 0@64];
assume limbs 64 [v_add105_3, v_shr_i242_3] = limbs 64 [v124, 0] + limbs 64 [v_add82_3_3, 0] && true;
...
(* generated by python *)
assert true && limbs 64 [v_add111_3, v_shr_i237_3] = limbs 64 [v_shr_i242_3, 0@64] + limbs 64 [v_add90_3_3, 0@64];
assume limbs 64 [v_add111_3, v_shr_i237_3] = limbs 64 [v_shr_i242_3, 0] + limbs 64 [v_add90_3_3, 0] && true;
...
(* generated by python *)
assert true && limbs 64 [v_add105_4, v_shr_i242_4] = limbs 64 [v135, 0@64] + limbs 64 [v_add82_4_2, 0@64];
assume limbs 64 [v_add105_4, v_shr_i242_4] = limbs 64 [v135, 0] + limbs 64 [v_add82_4_2, 0] && true;
...
(* generated by python *)
assert true && limbs 64 [v_add111_4, v_shr_i237_4] = limbs 64 [v_shr_i242_4, 0@64] + limbs 64 [v_add90_4_2, 0@64];
assume limbs 64 [v_add111_4, v_shr_i237_4] = limbs 64 [v_shr_i242_4, 0] + limbs 64 [v_add90_4_2, 0] && true;
...
(* generated by python *)
assert true && limbs 64 [v_add105_5, v_shr_i242_5] = limbs 64 [v143, 0@64] + limbs 64 [v_add82_5_1, 0@64];
assume limbs 64 [v_add105_5, v_shr_i242_5] = limbs 64 [v143, 0] + limbs 64 [v_add82_5_1, 0] && true;
...
(* generated by python *)
assert true && limbs 64 [v_add111_5, v_shr_i237_5] = limbs 64 [v_shr_i242_5, 0@64] + limbs 64 [v_add90_5_1, 0@64];
assume limbs 64 [v_add111_5, v_shr_i237_5] = limbs 64 [v_shr_i242_5, 0] + limbs 64 [v_add90_5_1, 0] && true;
...
(* generated by python *)
assert true && limbs 64 [v_add105_6, v_shr_i242_6] = limbs 64 [v147, 0@64] + limbs 64 [v_add82_6, 0@64];
assume limbs 64 [v_add105_6, v_shr_i242_6] = limbs 64 [v147, 0] + limbs 64 [v_add82_6, 0] && true;
...
(* == modified == *)
assert true && discard_473 = 0@1;
assume discard_473 = 0 && true;
...
{
  (* mc = ma*R^-1 mod p503, i.e., mc * R = ma mod p503 *)
  eqmod limbs 64 [mc0, mc1, mc2, mc3, mc4, mc5, mc6, mc7] * (2**512)
        limbs 64 [ma00, ma01, ma02, ma03, ma04, ma05, ma06, ma07, ma08, ma09, ma10, ma11, ma12, ma13, ma14, ma15]
        (2**250 * 3**159 - 1)
  &&
  (* mc in [0, 2*p503-1] *)
  and [
    0@512 <=u limbs 64 [mc0, mc1, mc2, mc3, mc4, mc5, mc6, mc7],
    limbs 64 [mc0, mc1, mc2, mc3, mc4, mc5, mc6, mc7] <=u const 512 (2 * (2**250 * 3**159 - 1) - 1)
  ]
}
