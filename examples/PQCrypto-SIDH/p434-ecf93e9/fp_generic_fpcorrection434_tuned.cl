(* @laptop: cv -isafety -v fp_generic_fpcorrection434_tuned.cl
Parsing Cryptoline file:		[OK]		0.003061 seconds
Checking well-formedness:		[OK]		0.000800 seconds
Transforming to SSA form:		[OK]		0.000249 seconds
Normalizing specification:		[OK]		0.000434 seconds
Rewriting assignments:			[OK]		0.000328 seconds
Verifying program safety:		[OK]		0.363763 seconds
Verifying range specification:		[OK]		15.131889 seconds
Rewriting value-preserved casting:	[OK]		0.000047 seconds
Verifying algebraic specification:	[OK]		0.000166 seconds
Verification result:			[OK]		15.501408 seconds
*)
...
mov a_40 a5;
mov a_48 a6;
mov p434_0 0xFFFFFFFFFFFFFFFF@uint64;
mov p434_8 0xFFFFFFFFFFFFFFFF@uint64;
mov p434_16 0xFFFFFFFFFFFFFFFF@uint64;
mov p434_24 0xFDC1767AE2FFFFFF@uint64;
mov p434_32 0x7BC65C783158AEA3@uint64;
mov p434_40 0x6CFC5FD681C52056@uint64;
mov p434_48 0x0002341F27177344@uint64;
...
subb discard v_sub12 (0)@uint64 v_conv11;
...
adds discard v_add24 v_and23 v14;
...
adds discard v_add_1 v16 v_or32;
...
adds discard v_add24_1 v_and23_1 v_add_1;
...
adds discard v_add_2 v19 v_or32_1;
...
adds discard v_add24_2 v_and23_2 v_add_2;
...
adds discard v_add_3 v22 v_or32_2;
...
adds discard v_add24_3 v_and23_3 v_add_3;
...

{
  ...
  and [
    ...
    limbs 64 [c0, c1, c2, c3, c4, c5, c6] <=u const 448 ((2**216 * 3**137 - 1) - 1)
  ]
}
