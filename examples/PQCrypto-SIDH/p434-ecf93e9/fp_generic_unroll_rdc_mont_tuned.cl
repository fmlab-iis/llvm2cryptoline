...
Parsing Cryptoline file:		[OK]		0.018418 seconds
Checking well-formedness:		[OK]		0.005883 seconds
Transforming to SSA form:		[OK]		0.004272 seconds
Normalizing specification:		[OK]		0.001940 seconds
Rewriting assignments:			[OK]		0.000871 seconds
Verifying program safety:		[OK]		8.439373 seconds
Verifying range assertions:		[OK]		72.259688 seconds
Verifying range specification:		[OK]		387.409627 seconds
Rewriting value-preserved casting:	[OK]		0.000140 seconds
Verifying algebraic assertions:		[OK]		0.002810 seconds
Verifying algebraic specification:	[OK]		0.294685 seconds
Verification result:			[OK]		468.441157 seconds
*)

proc main (uint64 ma00, uint64 ma01, uint64 ma02, uint64 ma03, uint64 ma04, uint64 ma05, uint64 ma06, uint64 ma07, uint64 ma08, uint64 ma09, uint64 ma10, uint64 ma11, uint64 ma12, uint64 ma13) =
{
  true
  &&
  (* p434 = 2^216*3^137-1 *)
  (* R = 2^448 *)
  (* ma < 2^448*p434 *)
  limbs 64 [ma00, ma01, ma02, ma03, ma04, ma05, ma06, ma07, ma08, ma09, ma10, ma11, ma12, ma13]
    <u const 896 (2**448) * const 896 (2**216 * 3**137 - 1)
}
...
mov p434p1_0 0x0000000000000000@uint64;
mov p434p1_8 0x0000000000000000@uint64;
mov p434p1_16 0x0000000000000000@uint64;
mov p434p1_24 0xFDC1767AE3000000@uint64;
mov p434p1_32 0x7BC65C783158AEA3@uint64;
mov p434p1_40 0x6CFC5FD681C52056@uint64;
mov p434p1_48 0x0002341F27177344@uint64;
...
(* generated by python *)
assert true && limbs 64 [v_add82, v_shr_i260] = limbs 64 [v_xor68_i278, 0@64] + limbs 64 [v_add41_6, 0@64];
assume limbs 64 [v_add82, v_shr_i260] = limbs 64 [v_xor68_i278, 0] + limbs 64 [v_add41_6, 0] && true;
...
(* generated by python *)
assert true && limbs 64 [v_add90, v_or94325] = limbs 64 [v_shr_i260, 0@64] + limbs 64 [v_xor2569_i290, 0@64] + limbs 64 [v_add48_6, 0@64];
assume limbs 64 [v_add90, v_or94325] = limbs 64 [v_shr_i260, 0] + limbs 64 [v_xor2569_i290, 0] + limbs 64 [v_add48_6, 0] && true;
...
(* generated by python *)
assert true && limbs 64 [v_add105, v_shr_i242] = limbs 64 [v56, 0@64] + limbs 64 [v_add82_3501, 0@64];
assume limbs 64 [v_add105, v_shr_i242] = limbs 64 [v56, 0] + limbs 64 [v_add82_3501, 0] && true;
...
(* generated by python *)
assert true && limbs 64 [v_add111, v_shr_i237] = limbs 64 [v_shr_i242, 0@64] + limbs 64 [v_add90_3508, 0@64];
assume limbs 64 [v_add111, v_shr_i237] = limbs 64 [v_shr_i242, 0] + limbs 64 [v_add90_3508, 0] && true;
...
(* generated by python *)
assert true && limbs 64 [v_add105_1, v_shr_i242_1] = limbs 64 [v70, 0@64] + limbs 64 [v_add82_1_3, 0@64];
assume limbs 64 [v_add105_1, v_shr_i242_1] = limbs 64 [v70, 0] + limbs 64 [v_add82_1_3, 0] && true;
...
(* generated by python *)
assert true && limbs 64 [v_add111_1, v_shr_i237_1] = limbs 64 [v_shr_i242_1, 0@64] + limbs 64 [v_add90_1_3, 0@64];
assume limbs 64 [v_add111_1, v_shr_i237_1] = limbs 64 [v_shr_i242_1, 0] + limbs 64 [v_add90_1_3, 0] && true;
...
(* generated by python *)
assert true && limbs 64 [v_add105_2, v_shr_i242_2] = limbs 64 [v84, 0@64] + limbs 64 [v_add82_2_3, 0@64];
assume limbs 64 [v_add105_2, v_shr_i242_2] = limbs 64 [v84, 0] + limbs 64 [v_add82_2_3, 0] && true;
...
(* generated by python *)
assert true && limbs 64 [v_add111_2, v_shr_i237_2] = limbs 64 [v_shr_i242_2, 0@64] + limbs 64 [v_add90_2_3, 0@64];
assume limbs 64 [v_add111_2, v_shr_i237_2] = limbs 64 [v_shr_i242_2, 0] + limbs 64 [v_add90_2_3, 0] && true;
...
(* generated by python *)
assert true && limbs 64 [v_add105_3, v_shr_i242_3] = limbs 64 [v95, 0@64] + limbs 64 [v_add82_3_2, 0@64];
assume limbs 64 [v_add105_3, v_shr_i242_3] = limbs 64 [v95, 0] + limbs 64 [v_add82_3_2, 0] && true;
...
(* generated by python *)
assert true && limbs 64 [v_add111_3, v_shr_i237_3] = limbs 64 [v_shr_i242_3, 0@64] + limbs 64 [v_add90_3_2, 0@64];
assume limbs 64 [v_add111_3, v_shr_i237_3] = limbs 64 [v_shr_i242_3, 0] + limbs 64 [v_add90_3_2, 0] && true;
...
(* generated by python *)
assert true && limbs 64 [v_add105_4, v_shr_i242_4] = limbs 64 [v103, 0@64] + limbs 64 [v_add82_4_1, 0@64];
assume limbs 64 [v_add105_4, v_shr_i242_4] = limbs 64 [v103, 0] + limbs 64 [v_add82_4_1, 0] && true;
...
(* generated by python *)
assert true && limbs 64 [v_add111_4, v_shr_i237_4] = limbs 64 [v_shr_i242_4, 0@64] + limbs 64 [v_add90_4_1, 0@64];
assume limbs 64 [v_add111_4, v_shr_i237_4] = limbs 64 [v_shr_i242_4, 0] + limbs 64 [v_add90_4_1, 0] && true;
...
(* generated by python *)
assert true && limbs 64 [v_add105_5, v_shr_i242_5] = limbs 64 [v107, 0@64] + limbs 64 [v_add82_5, 0@64];
assume limbs 64 [v_add105_5, v_shr_i242_5] = limbs 64 [v107, 0] + limbs 64 [v_add82_5, 0] && true;
...
(* == modified == *)
assert true && discard_337 = 0@1;
assume discard_337 = 0 && true;
...
{
  (* mc = ma*R^-1 mod p434, i.e., mc * R = ma mod p434 *)
  eqmod limbs 64 [mc0, mc1, mc2, mc3, mc4, mc5, mc6] * (2**448)
        limbs 64 [ma00, ma01, ma02, ma03, ma04, ma05, ma06, ma07, ma08, ma09, ma10, ma11, ma12, ma13]
        (2**216 * 3**137 - 1)
  &&
  (* mc in [0, 2*p434-1] *)
  and [
    0@448 <=u limbs 64 [mc0, mc1, mc2, mc3, mc4, mc5, mc6],
    limbs 64 [mc0, mc1, mc2, mc3, mc4, mc5, mc6] <=u const 448 (2 * (2**216 * 3**137 - 1) - 1)
  ]
}
