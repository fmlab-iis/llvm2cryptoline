(* @laptop: cv -v -isafety fp_generic_fpadd434_tuned.cl
Parsing Cryptoline file:		[OK]		0.003092 seconds
Checking well-formedness:		[OK]		0.000980 seconds
Transforming to SSA form:		[OK]		0.000500 seconds
Normalizing specification:		[OK]		0.000374 seconds
Rewriting assignments:			[OK]		0.000253 seconds
Verifying program safety:		[OK]		0.363987 seconds
Verifying range specification:		[OK]		22.594794 seconds
Rewriting value-preserved casting:	[OK]		0.000055 seconds
Verifying algebraic specification:	[OK]		0.000177 seconds
Verification result:			[OK]		22.964899 seconds
*)
...
(* == modified == *)
adds discard v_add3_1 v3 v_add_1;
...
(* == modified == *)
adds discard v_add_2 v5 v_or_1;
...
(* == modified == *)
adds discard v_add3_2 v6 v_add_2;
...
(* == modified == *)
adds discard v_add_3 v8 v_or_2;
...
(* == modified == *)
adds discard v_add3_3 v9 v_add_3;
...
(* == modified == *)
adds discard v_add_4 v11 v_or_3;
...
(* == modified == *)
adds discard v_add3_4 v12 v_add_4;
...
(* == modified == *)
adds discard v_add_5 v14 v_or_4;
...
(* == modified == *)
adds discard v_add3_5 v15 v_add_5;
...
(* == modified == *)
adds discard v_add_6 v17 v_or_5;
...
(* == modified == *)
adds discard v_add3_6 v18 v_add_6;
...
(* == modified == *)
subb discard v_sub27_1 v_sub_1 v_shr_i120;
...
(* == modified == *)
subb discard v_sub27_2 v_sub_2 v_conv26_2;
...
(* == modified == *)
subb discard v_sub27_3 v_sub_3 v_conv26_3;
...
(* == modified == *)
subb discard v_sub27_4 v_sub_4 v_conv26_4;
...
(* == modified == *)
subb discard v_sub27_5 v_sub_5 v_conv26_5;
...
(* == modified == *)
subb discard v_sub_i_i_6 (0)@uint64 v_sub_6;
...
(* == modified == *)
adds discard v_add47 v_and46 v33;
...
(* == modified == *)
adds discard v_add43_1 v35 v_or55;
...
(* == modified == *)
adds discard v_add47_1 v_and46_1 v_add43_1;
...
(* == modified == *)
adds discard v_add43_2 v38 v_or55_1;
...
(* == modified == *)
adds discard v_add47_2 v_and46_2 v_add43_2;
...
(* == modified = *)
adds discard v_add43_3 v41 v_or55_2;
...
(* == modified == *)
adds discard v_add47_3 v_and46_3 v_add43_3;
...
(* == modified == *)
adds discard v_add43_4 v_sub27_4 v_or55_3;
...
(* == modified == *)
adds discard v_add47_4 v_and46_4 v_add43_4;
...
(* == modified == *)
adds discard v_add43_5 v_sub27_5 v_or55_4;
...
(* == modified == *)
adds discard v_add47_5 v_and46_5 v_add43_5;
...
(* == modified == *)
adds discard v_add43_6 v_sub27_6 v_or55_5;
...
(* == modified == *)
adds discard v_add47_6 v_and46_6 v_add43_6;
...

{
  ...
  (* c in [0, 2*p434-1] *)
  and [
    equmod limbs 64 [c0, c1, c2, c3, c4, c5, c6]
