(* @laptop: cv -v -isafety fp_generic_fpcorrection610_tuned.cl
Parsing Cryptoline file:		[OK]		0.003338 seconds
Checking well-formedness:		[OK]		0.001114 seconds
Transforming to SSA form:		[OK]		0.000482 seconds
Normalizing specification:		[OK]		0.000439 seconds
Rewriting assignments:			[OK]		0.000300 seconds
Verifying program safety:		[OK]		0.518766 seconds
Verifying range specification:		[OK]		22.059094 seconds
Rewriting value-preserved casting:	[OK]		0.000071 seconds
Verifying algebraic specification:	[OK]		0.000184 seconds
Verification result:			[OK]		22.584537 seconds
*)
...
mov a_64 a8;
mov a_72 a9;
mov p610_0 0xFFFFFFFFFFFFFFFF@uint64;
mov p610_8 0xFFFFFFFFFFFFFFFF@uint64;
mov p610_16 0xFFFFFFFFFFFFFFFF@uint64;
mov p610_24 0xFFFFFFFFFFFFFFFF@uint64;
mov p610_32 0x6E01FFFFFFFFFFFF@uint64;
mov p610_40 0xB1784DE8AA5AB02E@uint64;
mov p610_48 0x9AE7BF45048FF9AB@uint64;
mov p610_56 0xB255B2FA10C4252A@uint64;
mov p610_64 0x819010C251E7D88C@uint64;
mov p610_72 0x000000027BF6A768@uint64;
...

{
  ...
  and [
    ...
    limbs 64 [c0, c1, c2, c3, c4, c5, c6, c7, c8, c9] <=u const 640 ((2**305 * 3**192 - 1) - 1)
  ]
}
