(* quine: -isafety -jobs 1
         Overall                        [OK]            1.019270 seconds
Verifying algebraic assertions:         [OK]            0.000976 seconds
Verifying range assertions:             [OK]            0.188448 seconds
Verifying range specification:          [OK]            0.255308 seconds
Verifying algebraic specification:      [OK]            0.037688 seconds
Verification result:                    [OK]            1.505075 seconds
*)

(* mac: -isafety -jobs 1
	 Overall			[OK]		1.641287 seconds
Verifying algebraic assertions:		[OK]		0.001734 seconds
Verifying range assertions:		[OK]		0.307727 seconds
Verifying range specification:		[OK]		0.304904 seconds
Verifying algebraic specification:	[OK]		0.044823 seconds
Verification result:			[OK]		2.302875 seconds
*)
...
(* == modified == *)
assert true && v_conv14_i = tmp_to_be_used;
assume v_conv14_i = tmp_to_be_used && true;
...
(* == modified == *)
adds discard v_fold_i v_shr40_i v_add_tr_i;
