(* quine: -isafety -jobs 1 -rename_local
         Overall                        [OK]            8.812881 seconds
Verifying algebraic assertions:         [OK]            0.006637 seconds
Verifying range assertions:             [OK]            3.099961 seconds
Verifying range specification:          [OK]            2.321391 seconds
Verifying algebraic specification:      [OK]            0.037365 seconds
Verification result:                    [OK]            14.287480 seconds
*)

(* mac: -isafety -jobs 1 -rename_local
	 Overall			[OK]		11.444111 seconds
Verifying algebraic assertions:		[OK]		0.005658 seconds
Verifying range assertions:		[OK]		3.776372 seconds
Verifying range specification:		[OK]		2.803724 seconds
Verifying algebraic specification:	[OK]		0.048036 seconds
Verification result:			[OK]		18.084196 seconds
*)

proc fiat_25519_carry_square (a0, a1, a2, a3, a4; c0, c1, c2, c3, c4) =
...
(*   tail call fastcc void @fiat_25519_carry_square(i64* %arraydecay, i64* %arraydecay2), !dbg !1353 *)
call fiat_25519_carry_square(L0_0, L0_8, L0_16, L0_24, L0_32, L1_0, L1_8, L1_16, L1_24, L1_32);
(*   ret void, !dbg !1356 *)
