...
define void @felem_shrink(i64* nocapture %out, i128* nocapture readonly %in) #0 {
entry:
...
entry:
  ...
  %4 = load i64, i64* %arrayidx21.i, align 8, !tbaa !6
  ...
  %5 = load i64, i64* %arrayidx37.i, align 8, !tbaa !6
  ...
  %6 = load i64, i64* %arrayidx62.i, align 8, !tbaa !6
  %conv63.i = zext i64 %6 to i128
  %mul66.i = mul nuw i128 %conv63.i, %conv2.i
  %shr68.i = lshr i128 %mul66.i, 64
  %conv70.i = and i128 %mul66.i, 18446744073709551615
  %arrayidx78.i = getelementptr inbounds i64, i64* %in2, i64 3
  %7 = load i64, i64* %arrayidx78.i, align 8, !tbaa !6
  ...
  %8 = load i64, i64* %arrayidx117.i, align 8, !tbaa !6
