(* frege: -v
Parsing Cryptoline file:		[OK]		0.004654 seconds
Checking well-formedness:		[OK]		0.003227 seconds
Transforming to SSA form:		[OK]		0.001997 seconds
Rewriting assignments:			[OK]		0.001323 seconds
Verifying program safety:		[OK]		0.166266 seconds
Verifying assertions:			[OK]		0.658867 seconds
Verifying range specification:		[OK]		0.260429 seconds
Verifying algebraic specification:	[OK]		0.030804 seconds
Verification result:			[OK]		1.128390 seconds
*)

proc main (a0, a1, a2, a3, b0, b1, b2, b3) =
{
  bveTrue
  |
  bvrTrue
...

{
  bveEqMod
    (limbs 64 [ bvvar c0_L,
	        ...
	        bvvar c7_H ])
    (
      (limbs 64 [ bvvar a0, bvvar a1, bvvar a2, bvvar a3 ])
      *
      (limbs 64 [ bvvar b0, bvvar b1, bvvar b2, bvvar b3 ])
    )
  ...
  (* c[i] < 7 * 2^64 *)
  bvrands [
    limbs 64 [ bvvar c0_L, bvvar c0_H ]
    < bvrmul (bvconst 128 7)
             (limbs 64 [bvconst 64 0, bvconst 64 (2^0)]),
    limbs 64 [ bvvar c1_L, bvvar c1_H ]
    < bvrmul (bvconst 128 7)
             (limbs 64 [bvconst 64 0, bvconst 64 (2^0)]),
    limbs 64 [ bvvar c2_L, bvvar c2_H ]
    < bvrmul (bvconst 128 7)
             (limbs 64 [bvconst 64 0, bvconst 64 (2^0)]),
    limbs 64 [ bvvar c3_L, bvvar c3_H ]
    < bvrmul (bvconst 128 7)
             (limbs 64 [bvconst 64 0, bvconst 64 (2^0)]),
    limbs 64 [ bvvar c4_L, bvvar c4_H ]
    < bvrmul (bvconst 128 7)
             (limbs 64 [bvconst 64 0, bvconst 64 (2^0)]),
    limbs 64 [ bvvar c5_L, bvvar c5_H ]
    < bvrmul (bvconst 128 7)
             (limbs 64 [bvconst 64 0, bvconst 64 (2^0)]),
    limbs 64 [ bvvar c6_L, bvvar c6_H ]
    < bvrmul (bvconst 128 7)
             (limbs 64 [bvconst 64 0, bvconst 64 (2^0)]),
    limbs 64 [ bvvar c7_L, bvvar c7_H ]
    < bvrmul (bvconst 128 7)
             (limbs 64 [bvconst 64 0, bvconst 64 (2^0)])
  ]
}
