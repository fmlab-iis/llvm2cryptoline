...
define void @smallfelem_mul(i128* nocapture %out, i64* nocapture readonly %small1, i64* nocapture readonly %small2) #0 {
entry:
...
entry:
  ...
  call void @smallfelem_mul(i128* %arraydecay, i64* %in1, i64* %in2)
  %arraydecay1 = getelementptr inbounds [4 x i128], [4 x i128]* %tmp, i64 0, i64 0
  %2 = load i128, i128* %arraydecay, align 16, !tbaa !6
  %add.i = add i128 %2, 1267650600228229401427983728624
  %arrayidx2.i = getelementptr inbounds [8 x i128], [8 x i128]* %longtmp, i64 0, i64 1
  %3 = load i128, i128* %arrayidx2.i, align 16, !tbaa !6
  ...
  %4 = load i128, i128* %arrayidx5.i, align 16, !tbaa !6
  ...
  %5 = load i128, i128* %arrayidx8.i, align 16, !tbaa !6
  ...
  %6 = load i128, i128* %arrayidx.i.i, align 16, !tbaa !6
  %arrayidx1.i.i = getelementptr inbounds [8 x i128], [8 x i128]* %longtmp, i64 0, i64 5
  %7 = load i128, i128* %arrayidx1.i.i, align 16, !tbaa !6
  ...
  %8 = load i128, i128* %arrayidx6.i.i, align 16, !tbaa !6
  ...
  %9 = load i128, i128* %arrayidx24.i.i, align 16, !tbaa !6
