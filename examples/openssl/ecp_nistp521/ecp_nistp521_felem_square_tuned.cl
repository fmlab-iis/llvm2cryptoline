...
proc main (in0, in1, in2, in3, in4, in5, in6, in7, in8) =
{
  ...
  |
  bvrands [
    bvvar in0 <= bvconst 64 (2^62) - bvconst 64 (2^57),
    bvvar in1 <= bvconst 64 (2^62) - bvconst 64 (2^57), 
    bvvar in2 <= bvconst 64 (2^62) - bvconst 64 (2^57),
    bvvar in3 <= bvconst 64 (2^62) - bvconst 64 (2^57), 
    bvvar in4 <= bvconst 64 (2^62) - bvconst 64 (2^57),
    bvvar in5 <= bvconst 64 (2^62) - bvconst 64 (2^57), 
    bvvar in6 <= bvconst 64 (2^62) - bvconst 64 (2^57),
    bvvar in7 <= bvconst 64 (2^62) - bvconst 64 (2^57), 
    bvvar in8 <= bvconst 64 (2^62) - bvconst 64 (2^57)
  ]
}
...
bvAssign out0_L (bvVar   L1_0);
bvAssign out0_H (bvVar   L1_8);
bvAssign out1_L (bvVar  L1_16);
bvAssign out1_H (bvVar  L1_24);
bvAssign out2_L (bvVar  L1_32);
bvAssign out2_H (bvVar  L1_40);
bvAssign out3_L (bvVar  L1_48);
bvAssign out3_H (bvVar  L1_56);
bvAssign out4_L (bvVar  L1_64);
bvAssign out4_H (bvVar  L1_72);
bvAssign out5_L (bvVar  L1_80);
bvAssign out5_H (bvVar  L1_88);
bvAssign out6_L (bvVar  L1_96);
bvAssign out6_H (bvVar L1_104);
bvAssign out7_L (bvVar L1_112);
bvAssign out7_H (bvVar L1_120);
bvAssign out8_L (bvVar L1_128);
bvAssign out8_H (bvVar L1_136);
