...
(* NOTE: tmp << 6 = shl *)
bvAssert bvTrue | bvrEq (bvvar shl) (bvrmul (bvconst 64 (2^6)) (bvvar tmp_to_be_used));
bvAssume bveEq (bvvar shl) ((bvvar tmp_to_be_used) * (bvconst (2^6))) | bvTrue;
...
(* NOTE: tmp << 6 = shl58 *)
bvAssert bvTrue | bvrEq (bvvar shl58) (bvrmul (bvconst 64 (2^6)) (bvvar tmp_to_be_used));
bvAssume bveEq (bvvar shl58) ((bvvar tmp_to_be_used) * (bvconst (2^6))) | bvTrue;
...
(* NOTE: tmp << 6 = shl76 *)
bvAssert bvTrue | bvrEq (bvvar shl76) (bvrmul (bvconst 64 (2^6)) (bvvar tmp_to_be_used));
bvAssume bveEq (bvvar shl76) ((bvvar tmp_to_be_used) * (bvconst (2^6))) | bvTrue;
...
(* NOTE: tmp << 6 = shl94 *)
bvAssert bvTrue | bvrEq (bvvar shl94) (bvrmul (bvconst 64 (2^6)) (bvvar tmp_to_be_used));
bvAssume bveEq (bvvar shl94) ((bvvar tmp_to_be_used) * (bvconst (2^6))) | bvTrue;
...
(* NOTE: tmp << 6 = shl112 *)
bvAssert bvTrue | bvrEq (bvvar shl112) (bvrmul (bvconst 64 (2^6)) (bvvar tmp_to_be_used));
bvAssume bveEq (bvvar shl112) ((bvvar tmp_to_be_used) * (bvconst (2^6))) | bvTrue;
...
(* NOTE: tmp << 6 = shl130 *)
bvAssert bvTrue | bvrEq (bvvar shl130) (bvrmul (bvconst 64 (2^6)) (bvvar tmp_to_be_used));
bvAssume bveEq (bvvar shl130) ((bvvar tmp_to_be_used) * (bvconst (2^6))) | bvTrue;
...
(* NOTE: tmp << 6 = shl148 *)
bvAssert bvTrue | bvrEq (bvvar shl148) (bvrmul (bvconst 64 (2^6)) (bvvar tmp_to_be_used));
bvAssume bveEq (bvvar shl148) ((bvvar tmp_to_be_used) * (bvconst (2^6))) | bvTrue;
...
(* NOTE: tmp << 6 = shl166 *)
bvAssert bvTrue | bvrEq (bvvar shl166) (bvrmul (bvconst 64 (2^6)) (bvvar tmp_to_be_used));
bvAssume bveEq (bvvar shl166) ((bvvar tmp_to_be_used) * (bvconst (2^6))) | bvTrue;
...
bvAssert bvTrue |
         bvrEq (bvradd (bvrmul (bvvar shr175) (bvconst 64 (2^58)))
                       (bvvar and32))
               (bvvar v18_L);
bvAssume bveEq (((bvvar shr175) * (bvconst (2^58))) + (bvvar and32))
               (bvvar v18_L)
               | bvTrue;
...
bvAssert bvTrue |
  bvrEq (bvradd (bvrmul (bvrsub (bvvar shl188)
                                (bvrmul (bvvar tmpH_h) (bvconst 64 (2^7))))
                        (bvconst 64 (2^57)))
                (bvvar shl181))
        (bvrmul (bvvar tmpH_l)
                (bvconst 64 (2^6)));
bvAssume bveEq ((((bvvar shl188) - ((bvvar tmpH_h) * (bvconst (2^7)))) *
                 (bvconst (2^57))) +
                (bvvar shl181))
               ((bvvar tmpH_l) * (bvconst (2^6))) |
         bvTrue;
(* C: out[0] += overflow1; *)
...

{
  ...
  |
  bvrands [
    bvvar out0 < (bvradd (bvconst 64 (2^59)) (bvconst 64 (2^14))),
    bvvar out1 < (bvradd (bvconst 64 (2^59)) (bvconst 64 (2^14))),
    bvvar out2 < (bvradd (bvconst 64 (2^59)) (bvconst 64 (2^14))),
    bvvar out3 < (bvradd (bvconst 64 (2^59)) (bvconst 64 (2^14))),
    bvvar out4 < (bvradd (bvconst 64 (2^59)) (bvconst 64 (2^14))),
    bvvar out5 < (bvradd (bvconst 64 (2^59)) (bvconst 64 (2^14))),
    bvvar out6 < (bvradd (bvconst 64 (2^59)) (bvconst 64 (2^14))),
    bvvar out7 < (bvradd (bvconst 64 (2^59)) (bvconst 64 (2^14))),
    bvvar out8 < (bvradd (bvconst 64 (2^59)) (bvconst 64 (2^14)))
  ]
}
