(* -v -btor -isafety
Parsing Cryptoline file:		[OK]		0.002046 seconds
Checking well-formedness:		[OK]		0.000508 seconds
Transforming to SSA form:		[OK]		0.000915 seconds
Rewriting assignments:			[OK]		0.000722 seconds
Verifying program safety:			[OK]		6.547769 seconds
Verifying range specification:		[OK]		6.708166 seconds
Verifying algebraic specification:	[OK]		0.130328 seconds
Verification result:			[OK]		13.391043 seconds
*)
...
{
  bveq
    (limbs 56 [limbs 64 [bvvar L2_0, bvvar L2_8], limbs 64 [bvvar L2_16, bvvar L2_24], limbs 64 [bvvar L2_32, bvvar L2_40], limbs 64 [bvvar L2_48, bvvar L2_56],
               limbs 64 [bvvar L2_64, bvvar L2_72], limbs 64 [bvvar L2_80, bvvar L2_88], limbs 64 [bvvar L2_96, bvvar L2_104]])
    (
  ...
  |
  bvands [
    limbs 64 [bvvar L2_0, bvvar L2_8] < bvconst 128 (2^121),
    limbs 64 [bvvar L2_16, bvvar L2_24] < bvconst 128 (2^121),
    limbs 64 [bvvar L2_32, bvvar L2_40] < bvconst 128 (2^121),
    limbs 64 [bvvar L2_48, bvvar L2_56] < bvconst 128 (2^121),
    limbs 64 [bvvar L2_64, bvvar L2_72] < bvconst 128 (2^121),
    limbs 64 [bvvar L2_80, bvvar L2_88] < bvconst 128 (2^121),
    limbs 64 [bvvar L2_96, bvvar L2_104] < bvconst 128 (2^121)
  ]
}
