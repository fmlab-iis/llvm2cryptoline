...
(*  %and = shl i128 %5, 40 *)
(*
bvConcatShl and_H tmp (bvVar v5_H) (bvVar v5_L) 40;
...
*)
bvAndb and_L (bvVar v5_L) (bvConst 0xFFFF);
bvShl shl_L (bvVar and_L) 40;
bvAssign shl_H (bvConst 0);
...
(*  %and25 = shl i128 %6, 40 *)
(*
bvConcatShl and25_H tmp (bvVar v6_H) (bvVar v6_L) 40;
...
*)
bvAndb and25_L (bvVar v6_L) (bvConst 0xFFFF);
bvShl shl26_L (bvVar and25_L) 40;
bvAssign shl26_H (bvConst 0);
...
(*
bvConcatShl and37_H tmp (bvVar add14_H) (bvVar add14_L) 40;
...
*)
bvAndb and37_L (bvVar add14_L) (bvConst 0xFFFF);
bvShl shl38_L (bvVar and37_L) 40;
bvAssign shl38_H (bvConst 0);
...
(* You may need to modify here *)
(* Correspond to the C code: output[2] += output[4] >> 16
   The value of output[4] is computed by the code: output[4] = output[3] >> 56 (output[4] = shr51, output[3] = add47) *)
(*
bvSplit shr56_L tmp_to_be_used (bvVar add47_H) 8;
bvAssign shr56_H (bvConst 0);
*)
bvSplit tmpL_h tmp_to_be_used (bvVar shr51_L) 16;
bvSplit tmpH_h tmpH_l (bvVar shr51_H) 16;
bvShl tmp (bvVar tmpH_l) 48;
bvAdd shr56_L (bvVar tmp) (bvVar tmpL_h);
bvAssign shr56_H (bvVar tmpH_h);
...
bvAssert bveTrue | bvrEq (bvvar shl61_L) (bvmul (bvvar tmp_to_be_used) (bvconst 64 (2^40)));
bvAssume bveq (bvvar shl61_L) (bvmul (bvvar tmp_to_be_used) (bvconst (2^40))) | bvrTrue;
